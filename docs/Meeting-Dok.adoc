...
Was zuerst nächstes Semester gemacht werden muss:
 - Server sendet Auth-Token immer mit, mit dem gearbeitet werden muss
 - evtl. Lernset mit UserID fertig machen
 - Quiz erstellen fertig machen, mit erstellendem UID
