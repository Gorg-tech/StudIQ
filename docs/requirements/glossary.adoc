...
| Objekt
| Titel nicht leer; Fragenanzahl ≥ 3
| Test, Abfrage
...
| Frage eines Quizzes
| Objekt
| Inhalt nicht leer; Bei Ankreuzaufgaben: Antwortmöglichkeitenanzahl ≥ 2 
| Question, Quizfrage

| Fragetyp
| Typ der Frage (Mutliple/Single Choice,...)
| enum 
| 
|

| Antwort-Möglichkeit
| Antwort-Möglichkeit für eine Quiz-Frage
| Objekt
| Inhalt nicht leer
