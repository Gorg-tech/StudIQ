...
| HTW-Student | HTW-Student der die Lernapp zur Prüfungsvorbereitung nutzen möchte. | HTW-Studenten sind die Hauptnutzer des Systems. Sie sind mitverantwortlich für die Erstellung von Quizfragen und -antworten und sorgen für ein interaktives Lernsystem.
| HTW-Dozent | Dozent der HTW-Dresden, der Lernmaterlialien zur Verfügung stellen möchte. | HTW- Dozenten sorgen für die Qualität der Lerninhalte. Sie sind hauptverantwortlich für die Erstellung von Quizfragen und -antworten und sorgen dafür, dass die Lerninhalte aktuell sind. 
| Gruppe 2B | Andere Gruppe, die Prüfungsvorbereiter anfertigt | Gibt uns Entwicklungsideen, Feature-ideen, motiviert für Projektfortschritt
|===
