...
Dieses Visions-Dokument bezieht sich auf das System HTW-Prüfungsvorbereiter, das vom Team entwickelt wird. Das System wird es Studenten der HTW-Dresden erlauben, eine kompetitive und gamifizierte Lernapp zu nutzen, um damit die Prüfungsvorbereitung zu erleichtern.
