...
So haben wir viele User Stories gehabt, welche wohl nur teilweise umgesetzt werden im gesamten überiterativen Entwicklungsprozess.

Zum Einen lag unser Problem darin, dass wir uns vor der Entwicklung nicht viele Gedanken darüber gemacht haben, welche Anforderungen unsere App NICHT erfüllen soll, also 'out of Scope' sind. 
...
Nach Absprache mit anderen Teams in SE ist uns dann aufgefallen, dass wir auch die Stakeholder stoppen können und sollten, wenn sie zu viele Feature-Wünsche haben. Dies konnten wir dann in den letzten beiden Iterationen noch umsetzen, sodass der PO deutlich sagt, falls es genug Input ist, bzw. die Developer zu Wort kommen, falls sie erkennen, dass ein Feature zu viel Zeit in Anspruch nehmen wird.

So konnten wir unser User-Story-Backlog in den letzten Iteration verkleinern, was auch für das Refinement wichtig geworden ist.
