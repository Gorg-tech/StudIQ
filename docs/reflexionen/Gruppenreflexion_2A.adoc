...
So haben wir gelernt, dass Dokumentation genauso wichtig ist wie funktionierender Code.
...
Der Grund für die Länge des Meetings lag daran, dass wir den Weekly Stand-up nicht so durchgeführt haben, wie es eigentlich gemacht werden soll:
...
Ein geordnetes Refinement der User Stories gab es bei uns nicht wirklich, die Priorität und Komplexität dieser wurde bei dieser Diskussion festgelegt.
