...
So wurden Implementier-Tasks auch von anderen (über-)motivierten Developern übernommen, so dass dann zwei Personen am selben Feature geschrieben hatten, aber unterschiedliche Codes. 
