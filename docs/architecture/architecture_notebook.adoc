...
. **Deployment:** Entwicklung auf SQLite, Produktion auf MySQL . Nutzung von CI/CD für automatisierte Deployments.
...
* **Datenbank:** Relational (SQLite für Entwicklung, MySQL für Produktion).
...
* **Backend-Komponenten:** User-Management, Quiz-API, Lernset-API, Modul-API, Fortschritt-API, Feedback-API, Authentifizierung.
...
* **Datenbank:** Separater Datenbankserver .
