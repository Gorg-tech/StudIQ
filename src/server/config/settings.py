...
SECRET_KEY = 'django-insecure-vktr$*&dc=2(1iz_xeeo5d)51z7lknkq3m67jv@tqfz*ukhg=y'
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt', #solches Typ vom Token ist einfacher zum Implementieren
    'accounts',
    'quizzes',
    'corsheaders',
]
