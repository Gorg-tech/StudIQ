...
from .views import QuizViewSet, QuestionViewSet, LernsetViewSet,\
                    FeedbackViewSet, StudiengangViewSet, ModulViewSet,\
                    SearchView, AnswerOptionViewSet, SuggestedQuizzesView, LeaderboardViewSet,\
...
urlpatterns = [
    ...
    path('lernsets/<uuid:lernset_id>/quizzes/', QuizzesByLernsetView.as_view(),
